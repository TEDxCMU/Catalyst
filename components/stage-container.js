        ...
        {loginStatus === "loggedIn" ? (
          <div className={cn(styles.stream, styleUtils.appear, styleUtils["appear-first"])}>
            ...
            <div className={cn(styles.bottom, styleUtils.appear, styleUtils["appear-second"])}>
              ...
              <a href={stage.chat_link} target='_blank' rel='noopener noreferrer' className={styles.button}>
                <span>Join the chat on</span>
                <svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='55 50 170 170'>
                  <g>
                    <g>
                      <path
                        fill='#E01E5A'
